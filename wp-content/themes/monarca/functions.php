...
function monarca_setup() {

	/* Make theme available for translation. */
	load_theme_textdomain( 'monarca' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'monarca' )
	) );
}
add_action( 'after_setup_theme', 'monarca_setup' );


/* Add scripts and styles */
function monarca_scripts() {
	...
	wp_enqueue_style( 'monarca-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'monarca_scripts' );


// Add custom post type to search query
function monarca_cpt_search( $query ) {
...
add_filter( 'pre_get_posts', 'monarca_cpt_search' );